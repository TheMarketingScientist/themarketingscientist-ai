---
title: "<br><br><br><br><br><br>AI High Value Audiences <br><br> Part 1: Comparing to lookalike audiences, identifying best Telco audiences to target for increased CLV and deploying them to marketing platforms <br><br>"
author: Andres Acosta
date: 2025-03-17
image: ../images/best-audience.png
description: In this article I compare my AI High Value Audiences (AI HVAs) to lookalike (LAL) audience methods like those used by Meta, several other platforms and some advertising agencies (WPP, RAPP and IPG). I identify high value Telco audiences for CLV (Customer Life Value) as the main business KPI. The article closes with a guidance on AI HVAs deployment on Marketing Platforms.
featured: true
format:
  html:
    theme: cosmo
...
<section class="article-cta">
  <p class="article-cta-question"><strong>Deciding whether AI-powered high-value audiences can improve targeting across channels?</strong></p>
